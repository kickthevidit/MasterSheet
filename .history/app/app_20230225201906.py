...
def summarize_pdf(filename):
    ...
    if filename.endswith(".pdf"):
        ...
        response = openai.Completion.create(engine=model,prompt=prompt,temperature=0.5)
...
def get_equations(filename):
    ...
    if filename.endswith(".pdf"):
        ...
        for page in pdfReader.pages:
            ...
            math_strings = re.findall(r"\$.*?\$", text) # parsing using regex/la library to get math equations
